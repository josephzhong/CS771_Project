...
from model_utils import MMR2TMetaEmbed
...
if __name__ == '__main__':
    ...
    model, tokenizer = MMR2TMetaEmbed.load_model(model_name, save_path, tokenizer,
    ...
    eval_loader = make_dataloader(tokenizer, args.batch_size, args.dataset_split_eval, args,
                                  model.groups_q, model.groups_c, processor=processor,
                                  problem_col_name=args.problem_col_name, shuffle=False)
