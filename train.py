...
from model_utils import load_base_model, MMR2TMetaEmbed
...
def main():
    ...
    model = MMR2TMetaEmbed(base, tokenizer, args.groups_q, args.groups_c, args.temperature, lora_cfg, args.soft_weight)
